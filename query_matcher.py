...
class QueryMatcher(object):
    ...
    def getProperties(self, statement):
        ...
        for each in doc.ents:
            ...
            elif str(each.label_) == "TIME" or str(each.label_) == "DATE" or str(each.label_) == "CARDINAL" or str(
                    each.label_) == "QUANTITY":
    ...
    def getMaximumScoringKey(self, replace, statement, i):
        ...
        if (replace.entity == "price"):
            ...
            for ent in doc.ents:
                ...
                if str(ent.label_) == "DATE" or str(ent.label_) == "TIME" or str(ent.label_) == "CARDINAL" or str(
                        ent.label_) == "QUANTITY":
                    time = str(ent)
                    try:
